...
// Constructor for DeviceResources12.
DX::DeviceResources12::DeviceResources12(DXGI_FORMAT backBufferFormat, DXGI_FORMAT depthBufferFormat) :
	m_currentFrame(0),
	m_screenViewport(),
...
void DX::DeviceResources12::CreateDeviceIndependentResources()
{
}

// Configures the Direct3D device, and stores handles to it and the device context.
void DX::DeviceResources12::CreateDeviceResources()
{
#if defined(_DEBUG)
...
void DX::DeviceResources12::CreateWindowSizeDependentResources()
{
	...
	if (m_swapChain != nullptr)
	{
		...
		if (hr == DXGI_ERROR_DEVICE_REMOVED || hr == DXGI_ERROR_DEVICE_RESET)
		{
			...
			// Do not continue execution of this method. DeviceResources12 will be destroyed and re-created.
			return;
		}
		else
		{
...
void DX::DeviceResources12::UpdateRenderTargetSize()
{
...
void DX::DeviceResources12::SetWindow(CoreWindow^ window)
{
...
void DX::DeviceResources12::SetLogicalSize(Windows::Foundation::Size logicalSize)
{
...
void DX::DeviceResources12::SetDpi(float dpi)
{
	if (dpi != m_dpi)
	{
		m_dpi = dpi;
...
void DX::DeviceResources12::SetCurrentOrientation(DisplayOrientations currentOrientation)
{
...
void DX::DeviceResources12::ValidateDevice()
{
...
void DX::DeviceResources12::Present()
{
...
void DX::DeviceResources12::WaitForGpu()
{
...
void DX::DeviceResources12::MoveToNextFrame()
{
	// Schedule a Signal command in the queue.
...
DXGI_MODE_ROTATION DX::DeviceResources12::ComputeDisplayRotation()
{
...
void DX::DeviceResources12::GetHardwareAdapter(IDXGIAdapter1** ppAdapter)
{
	ComPtr<IDXGIAdapter1> adapter;
	*ppAdapter = nullptr;
